...
# Execute a test file. It is assumed that this will be a .tcl file. It will
...
run_test() {
	test_file="$1"
	test_name="$(basename "$test_file" .tcl)"
	test_failed=0
	test_segfaulted=0
...
print_divider '=' 25 "NOCSIM TEST SUITE"
